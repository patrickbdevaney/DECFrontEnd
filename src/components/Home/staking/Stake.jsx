      ...
      <div className="">
        <div className="flex  py-5  gap-9 ">
          ...
          <span className="bg-[#DEFFD8] flex items-center justify-center rounded-[21px] py-1 px-3">
            <span className="text-skin-green">Buy {title} with FIAT</span>
          </span>
        </div>
      ...
      <div className="py-8 z-50 flex gap-3">
        ...
        <div className="basis-[55%] text-center ">
          <div className="flex flex-col gap-2">
            <h2 className="text-lg text-skin-lightDark">Staked {title}</h2>
          ...
          <div className="flex flex-col gap-2">
            <h2 className="text-lg text-skin-lightDark">Claimable {title}</h2>
            <h2 className="text-2xl text-[#666666]">{totalClaimble}</h2>
            <p className="text-[#333333] text-base">{title} per month</p>
